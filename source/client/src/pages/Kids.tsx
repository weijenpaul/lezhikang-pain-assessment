...
function Landing({ onStart }: { onStart: () => void }) {
  return (
    <>
      {/* Hero */}
      <section className="container grid items-center gap-10 py-14 md:grid-cols-[1.1fr_1fr] md:py-20">
        <div>
        ...
        <div className="container grid gap-8 md:grid-cols-[1.2fr_1fr] md:items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              >
                <p className="text-2xl font-black">{item.num}</p>
    ...
    <section className="container flex justify-center py-14">
      <div className="w-full max-w-lg">
        ...
        <div className="rounded-3xl bg-card p-8 shadow-sm md:p-10">
          ...
          <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
            系統會自動計算實足年齡，載入最適合的年齡題組。所有資料只在您的瀏覽器中運算，不會被儲存。
          </p>
          ...
          <div className="mt-8 flex flex-col gap-6">
            <div className="flex flex-col gap-2">
              ...
              <Input
                ...
                className="h-12 rounded-xl border-primary/25 bg-secondary/40 text-base focus-visible:border-primary focus-visible:ring-primary/30"
              />
  ...
  return (
    <section className="container flex justify-center py-10 md:py-14">
      <div className="w-full max-w-xl">
        ...
        <div className="mb-8 h-2.5 overflow-hidden rounded-full bg-secondary">
          <div
        ...
        <div
          key={animKey}
          className="quiz-card-enter rounded-3xl bg-card p-8 shadow-sm md:p-10"
        >
          <span
          ...
          <div className="mt-9 grid grid-cols-2 gap-4">
            <button
              ...
              className={`flex h-24 flex-col items-center justify-center gap-1.5 rounded-2xl border-2 text-lg font-bold transition-all duration-150 active:scale-[0.96] ${
                prevAnswer === true
            ...
            <button
              ...
              className={`flex h-24 flex-col items-center justify-center gap-1.5 rounded-2xl border-2 text-lg font-bold transition-all duration-150 active:scale-[0.96] ${
                prevAnswer === false
                  ? "border-foreground/70 bg-foreground text-background shadow-md"
  ...
  return (
    <section className="container flex justify-center py-10 md:py-14">
      <div className="w-full max-w-2xl">
        <p className="mb-2 text-center text-xs font-medium tracking-wide text-primary">
          STEP 3 / 3・檢核結果
        </p>

        {/* 結果總覽 */}
        <div
          className="rounded-3xl p-8 text-center shadow-sm md:p-10"
        ...
        >
          ...
          <p className="mt-4 text-xs text-muted-foreground">
            受測年齡：{age.displayAge}
            {age.corrected && "（已套用早產矯正年齡）"}・使用題組：
            {questionnaire.ageGroup}
          </p>
        </div>

        {/* 四面向分析 */}
        <div className="mt-8 rounded-3xl bg-card p-7 shadow-sm md:p-8">
                ...
                <div key={c.category}>
                  <div className="mb-1.5 flex items-center justify-between text-sm">
                    <span className="font-bold" style={{ color: meta.color }}>
                      {c.category}
                      {c.failedWarning && (
                        <span className="ml-2 rounded-full bg-[#FCEBE8] px-2 py-0.5 text-[11px] font-medium text-[#D9705F]">
                          含重點觀察項目
                        </span>
                      )}
                    </span>
        ...
        {/* 導流 CTA */}
        <div className="mt-8 rounded-3xl bg-primary p-8 text-primary-foreground shadow-md md:p-10">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {articles.map((a) => (
                <a
                  ...
                  className="group rounded-2xl border border-border/70 bg-card p-5 transition-all hover:-translate-y-0.5 hover:shadow-md"
                >
                  <h3 className="text-sm font-bold leading-relaxed text-foreground group-hover:text-primary">
                    {a.title}
                  </h3>
